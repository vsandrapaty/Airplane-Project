...
initialConditions = [0;0;12801.6;airplaneMass*Cruising Velocity;0;0];
...
for i = 1:length(diameterArray)
    ...
    A320 = Airplane(airplaneMass,bottomReference,frontalReferenceArea,name,numPassengers,initialConditions,paraset,xDragCoefficient,zDragCoefficient); 
